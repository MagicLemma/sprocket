...
glm::vec2 loadVec2(const std::string& line)
{
...
glm::vec3 loadVec3(const std::string& line)
{
    std::istringstream iss(line);
    float x, y, z;
    iss >> x >> y >> z;
        ...
        // will be populated.
            ...
            for (const auto& vertex : face) {
                ...
                if (it != seenFaces.end()) {
                    ...
                    glm::vec3 position = tempPositions[posIdx];
                    glm::vec2 texCoord = tempTexCoords[texIdx];
                    glm::vec3 normal   = tempNormals[norIdx];

...
int _get_NameComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_NameComponent(lua_State* L) {
...
int _add_NameComponent(lua_State* L) {
    if (!check_arg_count(L, 1 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_Transform3DComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_Transform3DComponent(lua_State* L) {
...
int _add_Transform3DComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_StaticModelComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_StaticModelComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_StaticModelComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_AnimatedModelComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_AnimatedModelComponent(lua_State* L) {
...
int _add_AnimatedModelComponent(lua_State* L) {
    if (!check_arg_count(L, 5 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_RigidBody3DComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_RigidBody3DComponent(lua_State* L) {
...
int _add_RigidBody3DComponent(lua_State* L) {
    if (!check_arg_count(L, 8 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_BoxCollider3DComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_BoxCollider3DComponent(lua_State* L) {
...
int _add_BoxCollider3DComponent(lua_State* L) {
    if (!check_arg_count(L, 4 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_SphereCollider3DComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_SphereCollider3DComponent(lua_State* L) {
...
int _add_SphereCollider3DComponent(lua_State* L) {
    if (!check_arg_count(L, 3 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_CapsuleCollider3DComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_CapsuleCollider3DComponent(lua_State* L) {
    if (!check_arg_count(L, 4 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_CapsuleCollider3DComponent(lua_State* L) {
    if (!check_arg_count(L, 4 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_ScriptComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_ScriptComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_ScriptComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_Camera3DComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_Camera3DComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_Camera3DComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_LightComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_LightComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_LightComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_SunComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_SunComponent(lua_State* L) {
    if (!check_arg_count(L, 4 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_SunComponent(lua_State* L) {
    if (!check_arg_count(L, 4 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_AmbienceComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_AmbienceComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_AmbienceComponent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_ParticleComponent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_ParticleComponent(lua_State* L) {
...
int _add_ParticleComponent(lua_State* L) {
    if (!check_arg_count(L, 6 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _get_CollisionEvent(lua_State* L) {
    if (!check_arg_count(L, 1)) { return luaL_error(L, "Bad number of args"); }
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, 1);
...
int _set_CollisionEvent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
int _add_CollisionEvent(lua_State* L) {
    if (!check_arg_count(L, 2 + 1)) { return luaL_error(L, "Bad number of args"); }
    int ptr = 0;
    auto& reg = *get_pointer<anvil::registry>(L, "__registry__");
    auto e = spkt::lua::converter<anvil::entity>::read(L, ++ptr);
...
void load_entity_component_functions(spkt::lua::script& script)
{
    ...
    lua_register(L, "_GetNameComponent", &_get_NameComponent);
    ...
    lua_register(L, "_SetNameComponent", &_set_NameComponent);
    ...
    lua_register(L, "_AddNameComponent", &_add_NameComponent);
    ...
    lua_register(L, "_GetTransform3DComponent", &_get_Transform3DComponent);
    ...
    lua_register(L, "_SetTransform3DComponent", &_set_Transform3DComponent);
    ...
    lua_register(L, "_AddTransform3DComponent", &_add_Transform3DComponent);
    ...
    lua_register(L, "_GetStaticModelComponent", &_get_StaticModelComponent);
    ...
    lua_register(L, "_SetStaticModelComponent", &_set_StaticModelComponent);
    ...
    lua_register(L, "_AddStaticModelComponent", &_add_StaticModelComponent);
    ...
    lua_register(L, "_GetAnimatedModelComponent", &_get_AnimatedModelComponent);
    ...
    lua_register(L, "_SetAnimatedModelComponent", &_set_AnimatedModelComponent);
    ...
    lua_register(L, "_AddAnimatedModelComponent", &_add_AnimatedModelComponent);
    ...
    lua_register(L, "_GetRigidBody3DComponent", &_get_RigidBody3DComponent);
    ...
    lua_register(L, "_SetRigidBody3DComponent", &_set_RigidBody3DComponent);
    ...
    lua_register(L, "_AddRigidBody3DComponent", &_add_RigidBody3DComponent);
    ...
    lua_register(L, "_GetBoxCollider3DComponent", &_get_BoxCollider3DComponent);
    ...
    lua_register(L, "_SetBoxCollider3DComponent", &_set_BoxCollider3DComponent);
    ...
    lua_register(L, "_AddBoxCollider3DComponent", &_add_BoxCollider3DComponent);
    ...
    lua_register(L, "_GetSphereCollider3DComponent", &_get_SphereCollider3DComponent);
    ...
    lua_register(L, "_SetSphereCollider3DComponent", &_set_SphereCollider3DComponent);
    ...
    lua_register(L, "_AddSphereCollider3DComponent", &_add_SphereCollider3DComponent);
    ...
    lua_register(L, "_GetCapsuleCollider3DComponent", &_get_CapsuleCollider3DComponent);
    ...
    lua_register(L, "_SetCapsuleCollider3DComponent", &_set_CapsuleCollider3DComponent);
    ...
    lua_register(L, "_AddCapsuleCollider3DComponent", &_add_CapsuleCollider3DComponent);
    ...
    lua_register(L, "_GetScriptComponent", &_get_ScriptComponent);
    ...
    lua_register(L, "_SetScriptComponent", &_set_ScriptComponent);
    ...
    lua_register(L, "_AddScriptComponent", &_add_ScriptComponent);
    ...
    lua_register(L, "_GetCamera3DComponent", &_get_Camera3DComponent);
    ...
    lua_register(L, "_SetCamera3DComponent", &_set_Camera3DComponent);
    ...
    lua_register(L, "_AddCamera3DComponent", &_add_Camera3DComponent);
    ...
    lua_register(L, "_GetLightComponent", &_get_LightComponent);
    ...
    lua_register(L, "_SetLightComponent", &_set_LightComponent);
    ...
    lua_register(L, "_AddLightComponent", &_add_LightComponent);
    ...
    lua_register(L, "_GetSunComponent", &_get_SunComponent);
    ...
    lua_register(L, "_SetSunComponent", &_set_SunComponent);
    ...
    lua_register(L, "_AddSunComponent", &_add_SunComponent);
    ...
    lua_register(L, "_GetAmbienceComponent", &_get_AmbienceComponent);
    ...
    lua_register(L, "_SetAmbienceComponent", &_set_AmbienceComponent);
    ...
    lua_register(L, "_AddAmbienceComponent", &_add_AmbienceComponent);
    ...
    lua_register(L, "_GetParticleComponent", &_get_ParticleComponent);
    ...
    lua_register(L, "_SetParticleComponent", &_set_ParticleComponent);
    ...
    lua_register(L, "_AddParticleComponent", &_add_ParticleComponent);
    ...
    lua_register(L, "_GetCollisionEvent", &_get_CollisionEvent);
    ...
    lua_register(L, "_SetCollisionEvent", &_set_CollisionEvent);
    ...
    lua_register(L, "_AddCollisionEvent", &_add_CollisionEvent);

...
int _GetCollisionEvent(lua_State* L) {
    ...
    spkt::lua::converter<game::entity>::push(L, c.entity_a);
    spkt::lua::converter<game::entity>::push(L, c.entity_b);
    return 2;
}
...
int _SetCollisionEvent(lua_State* L) {
    ...
    c.entity_a = spkt::lua::converter<game::entity>::read(L, ++ptr);
    c.entity_b = spkt::lua::converter<game::entity>::read(L, ++ptr);
    return 0;
}

...
{
    mat4 matrix(1.0);
    matrix = glm::rotate(matrix, glm::radians(pitch), vec3(1, 0, 0));
    matrix = glm::rotate(matrix, glm::radians(yaw), vec3(0, 1, 0));
    matrix = glm::rotate(matrix, glm::radians(roll), vec3(0, 0, 1));

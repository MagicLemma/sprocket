...
void EscapeMenu::OnUpdate(double dt)
{
    ...
    if (d_ui.StartPanel("Main", &mainRegion, true, false, true)) {
    ...
    if (d_ui.StartPanel("VolumePanel", &shape, showVolume, true, true)) {
    ...
    if (d_ui.StartPanel("Button Panel", &shape2, true, true, true)) {
